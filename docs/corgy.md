...
**NOTE**: `typing.Sequence/typing.List/typing.Set` do not accept multiple arguments,
...
**NOTE**: Groups will ignore any custom flags when computing the prefix; elements
